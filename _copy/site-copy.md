<!--
  ...
  ROUND-TRIP
    python3 _copy/copytool.py apply site
    python3 _copy/copytool.py check site
-->
...
## [HOME-EYEBROW]
WHERE: Small gold uppercase line above your name
FILE:  index.html
...
## [HOME-TAGLINE]
WHERE: Italic serif line under your name
FILE:  index.html
...
## [HOME-CATEGORIES]
WHERE: Grey keyword line under the bio
FILE:  index.html
...
## [HOME-CARD-RESEARCH]
WHERE: Description inside the wide Research card
FILE:  index.html
NOTE:  2-3 sentences.
TEXT:
...
## [HOME-CARD-AISAFETY]
WHERE: Description inside the Youth AI Safety card
FILE:  index.html
...
## [ABOUT-SUBTITLE]
WHERE: Grey line under the 'About Me' heading
FILE:  aboutme.md
...
## [ABOUT-INTRO-1]
WHERE: First paragraph, beside your headshot
FILE:  aboutme.md
...
## [ABOUT-CREDENTIALS]
WHERE: Paragraph about the MLS and publication venues
FILE:  aboutme.md
...
## [ABOUT-CLOSING]
WHERE: Final paragraph, the availability and contact pitch
FILE:  aboutme.md
...
## [RESEARCH-SUBTITLE]
WHERE: Grey line under the 'Research' heading
FILE:  research.md
...
# Research · Panel intros

## [RESEARCH-INTRO-RESEARCHERS]
WHERE: Boxed intro on the 'For Researchers' tab
FILE:  research.md
...
## [RESEARCH-INTRO-PRACTITIONERS]
WHERE: Boxed intro on the 'For Practitioners' tab
FILE:  research.md
...
# Research · Pillar descriptions

## [RESEARCH-PILLAR-1-DESC]
WHERE: Body of the 'Who Controls...' pillar card
FILE:  research.md
NOTE:  Long.
TEXT:
...
## [RESEARCH-PILLAR-2-DESC]
WHERE: Body of the 'How Institutions Govern...' pillar card
FILE:  research.md
NOTE:  Long.
TEXT:
School districts' acceptable-use policies, vendor contracts, teachers' plagiarism detectors, and platforms' age-gating rules shape how young people encounter AI. This thread examines how those institutions write and enforce AI rules, what assumptions the rules encode, and who bears the cost when they are wrong. I use the Governing Knowledge Commons and Contextual Integrity (GKC-CI) framework to examine how institutional rules reflect expectations about appropriate AI use and information sharing.
...
# Research · Practitioner accordion

## [RESEARCH-Q-1]
WHERE: Clickable question, Pillar 1 card
FILE:  research.md
NOTE:  Phrased as a question.
TEXT:
Who controls student data, and how much can schools learn about where it goes?

---

## [RESEARCH-Q-3]
WHERE: Clickable question, Pillar 3 card
FILE:  research.md
NOTE:  Phrased as a question.
TEXT:
When do young people want AI assistance, and how should their preferences inform its design?

---

## [RESEARCH-Q-4]
WHERE: Clickable question, Related/scams card
FILE:  research.md
NOTE:  Phrased as a question.
TEXT:
What do people experience during a scam, and why does current support infrastructure fall short?

---

## [RESEARCH-SOWHAT-3]
WHERE: 'Why it matters' text inside the Pillar 3 card
FILE:  research.md
NOTE:  The youth-preferences argument.
TEXT:
When school AI policies conflict with how students reason about acceptable use, students may conceal their use, making it harder to seek guidance or discuss problems. Young people's accounts can help explain why a rule is difficult to follow and how it could better support their learning and safety. Those perspectives also matter for designing AI systems that account for how young people learn, form identity, and assess risk.
...
## [PRESS-SUBTITLE]
WHERE: Grey line under the 'Press & Media' heading
FILE:  press.md
NOTE:  Very short.
TEXT:
...
## [PRESS-CONTACT]
WHERE: Second paragraph, the media-inquiry pitch
FILE:  press.md
...
## [CV-ROLE]
WHERE: Grey line under your name at the top of the CV
FILE:  CV.md
...
## [SHARED-CTA]
WHERE: The call-to-action box that appears at the bottom of research, about, press and /ai-safety
...
## [CONFIG-DESCRIPTION]
WHERE: The site-wide meta description, used on the homepage and in search results
