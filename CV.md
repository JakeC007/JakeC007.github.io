  ...
  <div class="page-inner">
    ...
    <div class="cv-section">
      ...
      <div class="edu-list">
        ...
        <div class="edu-item">
          <div class="edu-row">
            <span class="edu-school">University of Chicago Law School</span>
            <span class="edu-date">June 2024</span>
          </div>
    ...
    <div class="cv-section">
      ...
      <div class="cv-entries">
        ...
        <div class="cv-entry">
          <div class="cv-entry-top">
            <div class="cv-entry-title">K&ndash;12 Privacy and Security Research</div>
            <span class="cv-badge badge-blue">Lead Researcher</span>
          </div>
    ...
    <div class="cv-section">
      ...
      <div class="cv-entries">
        <div class="cv-entry">
          <div class="cv-entry-title">Madison's Security and Privacy Seminar: Privacy and Security Challenges In K&ndash;12 Schools</div>
          <div class="cv-entry-sub">Madison, WI &middot; Winter 2025</div>
        </div>
        <div class="cv-entry">
          <div class="cv-entry-title">Sony AI's Ethical AI Seminar: Exploring Data Trusts as a Way to Safeguard K&ndash;12 Student Data</div>
          <div class="cv-entry-sub">Zoom &middot; Winter 2025</div>
        </div>
        <div class="cv-entry">
